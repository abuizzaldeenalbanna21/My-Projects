            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="h3 mb-4 text-gray-800">Add Treatments</h1>
                        <div>
    ...
    <script>
        ...
        document.getElementById('editTreatmentForm').addEventListener('submit', function (e) {
            ...
            document.querySelectorAll('.treatment-group').forEach((group, index) => {
                ...
                const doctor = group.querySelector(`#doctor${index + 1}`).value;
                treatments.push({ name, description, doctor });
            });
