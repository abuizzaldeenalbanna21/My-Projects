            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="users.php" class="btn btn-secondary btn-circle" title="Return">
                        ...
                        <div class="card-body">
                            <form id="addPersonForm">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="typeOfWork">Type of user</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="index_cover.html">Logout</a>
                </div>
            </div>
        </div>
    </div>
